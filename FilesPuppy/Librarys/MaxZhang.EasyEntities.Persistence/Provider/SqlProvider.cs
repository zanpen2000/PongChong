...
namespace MaxZhang.EasyEntities.Persistence.Provider
{
    public class SqlProvider : IDataProvider
    {
        ...
        public IDataParameter CreateDataParameter(string name,object vlaue = null,ParameterDirection direction = ParameterDirection.Input)
        {
            var paramter = new SqlParameter(name,vlaue);
            paramter.Size = 50;
            paramter.Direction = direction;
            return paramter;
        }
    }
}