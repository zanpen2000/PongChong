...
namespace MaxZhang.EasyEntities.Persistence
{
    ...
    public abstract class QueryConditional
    {
        ...
        protected QueryConditional(Type[] dbtypes,Expression expr)
        {
            LoadObjects(dbtypes);
            string conditional = TranslateExtendtion.TranslateConditional(expr,null);
    ...
    public class QueryConditional<TModel>:QueryConditional
    {
        ...
        public QueryConditional(Expression<Func<TModel, bool>> expr):base(new Type[]{typeof(TModel)},expr)
        {
    ...
    public class QueryConditional<TModel1,TModel2> : QueryConditional
    {
        ...
        public QueryConditional(Expression<Func<TModel1, TModel2, bool>> expr)
            : base(new Type[] { typeof(TModel1),typeof(TModel2) }, expr)
        {
    ...
    public class QueryConditional<TModel1, TModel2, TModel3> : QueryConditional
    {
        ...
        public QueryConditional(Expression<Func<TModel1, TModel2, TModel3, bool>> expr)
            : base(new Type[] { typeof(TModel1), typeof(TModel2),typeof(TModel3) }, expr)
        {
    ...
    public class QueryConditional<TModel1, TModel2, TModel3, TModel4> : QueryConditional
    {
        ...
        public QueryConditional(Expression<Func<TModel1, TModel2, TModel3, TModel4, bool>> expr)
            : base(new Type[] { typeof(TModel1), typeof(TModel2), typeof(TModel3), typeof(TModel4) }, expr)
        {
    ...
    public class QueryConditional<TModel1, TModel2, TModel3, TModel4, TModel5> : QueryConditional
    {
        ...
        public QueryConditional(Expression<Func<TModel1, TModel2, TModel3, TModel4, TModel5, bool>> expr)
            : base(new Type[] { typeof(TModel1), typeof(TModel2), typeof(TModel3), typeof(TModel4), typeof(TModel5) }, expr)
        {
